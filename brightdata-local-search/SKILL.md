...
| `expand` | boolean | `false` | Enable AI query expansion via Codex |
...
- **Expanded** (`expand: true`): Codex Haiku generates 3 sub-queries for broader coverage
...
To give your Codex agent search capabilities:
